...
def evaluate_notable_objects_prediction(max_num_answer_objects, num_future_waypoints, data, npy_save_path, qa_type_id, match_threshold):
    ...
    action_accuracy_denominator = num_matched_gt_output_correct_action_count + num_matched_gt_output_incorrect_action_count
    action_accuracy = 0.0 if action_accuracy_denominator == 0 else 1.0 * num_matched_gt_output_correct_action_count / action_accuracy_denominator
    print('action_accuracy: ', action_accuracy)

    for threshold_id in range(len(thresholds)):
      localization_precision_denominator = num_outputs
      localization_precision = 0.0 if localization_precision_denominator == 0 else 1.0 * num_matched_gt_output[threshold_id] / localization_precision_denominator
      localization_recall_denominator = num_gts
      localization_recall = 0.0 if localization_recall_denominator == 0 else 1.0 * num_matched_gt_output[threshold_id] / localization_recall_denominator
      localization_f1_denominator = (localization_precision + localization_recall)
      localization_f1 = 0.0 if localization_f1_denominator == 0 else 2 * localization_precision * localization_recall / localization_f1_denominator
    ...
    binary_precision_denominator = (binary_tp + binary_fp)
    binary_precision = 0.0 if binary_precision_denominator == 0 else 1.0 * binary_tp / binary_precision_denominator
    binary_recall_denominator = (binary_tp + binary_fn)
    binary_recall = 0.0 if binary_recall_denominator == 0 else 1.0 * binary_tp / binary_recall_denominator
    binary_f1_denominator = (binary_precision + binary_recall)
    binary_f1 = 0.0 if binary_f1_denominator == 0 else 2 * binary_precision * binary_recall / binary_f1_denominator
